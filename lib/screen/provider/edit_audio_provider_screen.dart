...
class EditAudioWithProviderScreen extends StatefulWidget {
  final EditAudioWithProviderScreenArguments arguments;

  const EditAudioWithProviderScreen({
    Key? key,
    required Object? arguments,
  })  : assert(arguments != null && arguments is EditAudioWithProviderScreenArguments),
        this.arguments = arguments as EditAudioWithProviderScreenArguments,
        super(key: key);

  @override
  State<EditAudioWithProviderScreen> createState() => _EditAudioWithProviderScreenState();
}

class _EditAudioWithProviderScreenState extends State<EditAudioWithProviderScreen> {
...
class EditAudioWithProviderScreenArguments {
  int audioId;
  final Function() backButtonCallback;

  EditAudioWithProviderScreenArguments(
