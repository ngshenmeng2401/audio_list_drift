...
class _AudioDetailsWithGetItScreenState
  ...
  void initState() {
    // getAudioData();
    // setState(() {
    //   audioPlayerController.initAudioPlayer(widget.arguments.audioURL);
    // });
                    ...
                    children: [
                      StreamBuilder<int>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (snapshot.hasData) {
                              if (snapshot.data == widget.arguments.audioId) {
                                return Container(
                                  height: screenHeight * 0.2,
                                  width: screenWidth * 0.2,
                                  decoration: const BoxDecoration(
                            ...
                            return Container(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  audioPlayerController.audioIdControllerStream.sink.add(widget.arguments.audioId);
                                },
                              ),
                            );
                          }),
...
class AudioDetailWithGetItScreenArguments {
  ...
  AudioDetailWithGetItScreenArguments(
      ...
      required this.backButtonCallback2});
}
